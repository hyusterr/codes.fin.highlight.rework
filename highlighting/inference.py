...
def main():
    ...
    for b, batch in enumerate(dataloader):
        ...
        for i in range(len(word_ids)):
            ...
            predictions['probs_all'] = probs_holder_all
